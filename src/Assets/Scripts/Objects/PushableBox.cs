...
public class PushableBox : MonoBehaviour
{
                ...
                if (Mathf.Abs(Input.GetAxisRaw("Horizontal")) == 1f)
                {
                    ...
                    else
                    {
                        ...
                        if (collider.gameObject.GetComponent<PushableBox>() != null)
                        {
                            ...
                            collider.gameObject.GetComponent<PushableBox>().MoveHorizontal(Input.GetAxisRaw("Horizontal"), new Vector3(Input.GetAxisRaw("Horizontal"), 0f, 0f));
                        }
                    }
                    StartCoroutine(MoveDelay());
                }
                ...
                else if (Mathf.Abs(Input.GetAxisRaw("Vertical")) == 1f)
                {
                    ...
                    else
                    {
                        ...
                        if (collider.gameObject.GetComponent<PushableBox>() != null)
                        {
                            ...
                            collider.gameObject.GetComponent<PushableBox>().MoveHorizontal(Input.GetAxisRaw("Vertical"), new Vector3(0f, Input.GetAxisRaw("Vertical"), 0f));
                        }
                    }
    ...
    */
    ...
    public void MoveVertical(float axis, Vector3 dir)
    {
